                            ...
                            <tbody>
                                ...
                                foreach ($content as $row) : ?>
                                    <tr>
                                        ...
                                        <td><?= $row['total_trx'] ?></td>
                                        <td>
                                            <a href="<?= base_url('admin/tutor/edit/' . $row['id']) ?>"><button type="button" class="btn btn-primary btn-sm mr-1">Edit</button></a>
                                            <a href="<?= base_url('admin/tutor/delete/' . $row['id']) ?>"><button type="button" class="btn btn-danger btn-sm">Delete</button></a>
                                        </td>
                                    </tr>
                                <?php endforeach ?>
                            </tbody>
